    ...
    return (
        <div className="flex">
            ...
            <div className="bg-primary py-6 px-2 flex flex-col gap-12">
                ...
                <div className="my-4">
                    {selectedCategory && <p className="text-base font-semibold text-center text-white">Selected Category<br/> <br/> <span className="text-2xl">{categoriesTranslations[selectedCategory] ?? selectedCategory}</span></p>}
                </div>
